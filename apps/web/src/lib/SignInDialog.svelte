  ...
  <Dialog.Content class="sm:max-w-sm">
    <Dialog.Header>
      <Dialog.Title class="flex items-center gap-2">
        ...
        {authState.isAuthenticated ? "Account" : "Sign In"}
      </Dialog.Title>
    </Dialog.Header>
        ...
        <div class="space-y-3">
          ...
          <div class="space-y-1.5">
            <Button
              ...
              size="sm"
              class="w-full justify-start"
              onclick={() => { open = false; onOpenAccountSettings?.(); }}
            >
              Account Settings
            </Button>
            <Button
      ...
      {:else}
        ...
        <div class="space-y-3">
          {#if !verificationSent}
            ...
            <div class="space-y-1.5">
              <Label for="dialog-email" class="text-xs">Email</Label>
              <Input
                id="dialog-email"
                type="email"
                bind:value={email}
            ...
            <div>
              ...
              {#if showAdvanced}
                <div class="space-y-1.5 mt-2">
                  <Label for="dialog-server-url" class="text-xs">Server URL</Label>
                  <Input
