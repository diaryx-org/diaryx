...
export type Response = { "type": "Ok" } | { "type": "String", "data": string } | { "type": "Bool", "data": boolean } | { "type": "Entry", "data": EntryData } | { "type": "Tree", "data": TreeNode } | { "type": "Frontmatter", "data": { [key in string]?: JsonValue } } | { "type": "SearchResults", "data": SearchResults } | { "type": "ValidationResult", "data": ValidationResultWithMeta } | { "type": "FixResult", "data": FixResult } | { "type": "FixSummary", "data": FixSummary } | { "type": "ExportPlan", "data": ExportPlan } | { "type": "ExportedFiles", "data": Array<ExportedFile> } | { "type": "BinaryFiles", "data": Array<BinaryExportFile> } | { "type": "Templates", "data": Array<TemplateInfo> } | { "type": "Strings", "data": Array<string> } | { "type": "Bytes", "data": Array<number> } | { "type": "StorageInfo", "data": StorageInfo } | { "type": "AncestorAttachments", "data": AncestorAttachmentsResult };
