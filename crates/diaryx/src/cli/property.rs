            ...
            Ok(Some(value)) => match &value {
                ...
                _ => {
                    println!(
                        "{}{}",
                        prefix,
                        diaryx_core::yaml::to_string(&value)
                            .unwrap_or_default()
                            .trim()
                    );
                }
...
fn handle_set_command(
    ...
    let yaml_value = match diaryx_core::yaml::from_str::<yaml::Value>(value) {
        Ok(v) => v,
        Err(e) => {
            ...
            Ok(frontmatter) => {
                ...
                if yaml {
                    if frontmatter.is_empty() {
                        ...
                        match diaryx_core::yaml::to_string(&frontmatter) {
                            Ok(s) => print!("{}", s),
                            Err(e) => {
...
fn handle_list_append_command(
    ...
    handle_list_operation(
        ...
        |items| match diaryx_core::yaml::from_str::<yaml::Value>(value) {
            Ok(yaml_value) => {
...
fn handle_list_set_at_command(
    ...
    handle_list_operation(
        ...
        |items| {
            ...
            match diaryx_core::yaml::from_str::<yaml::Value>(value) {
                Ok(yaml_value) => {
