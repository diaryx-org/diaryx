...
import type { LinkParserOperation } from "./LinkParserOperation";
 ...
 */
body: string | null, } } | { "type": "ImportEntries", "params": {
/**
 ...
 */
operation: LinkParserOperation, } } | { "type": "ValidateWorkspaceName", "params": {
/**
 ...
 */
existing_local_names: Array<string>,
/**
 * Existing server workspace names (optional, for sync uniqueness check).
 */
existing_server_names: Array<string> | null, } } | { "type": "ValidatePublishingSlug", "params": {
/**
 * The slug to validate.
 */
slug: string, } } | { "type": "NormalizeServerUrl", "params": {
/**
 * The URL to normalize.
 */
url: string, } } | { "type": "ToWebSocketSyncUrl", "params": {
/**
