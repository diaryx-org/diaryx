...
//!
//! The live-share guest is built as a Wasm `cdylib`, but native unit-test
//! builds still try to link the target. These inert shims satisfy the Extism
//! ABI symbols that are normally provided by the runtime.
